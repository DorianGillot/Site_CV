...
public:
	...
	void ReadRaw(const uintptr_t address, void* buffer, size_t size) const noexcept {
		::ReadProcessMemory(processHandle, reinterpret_cast<LPCVOID>(address), buffer, size, nullptr);
	}
