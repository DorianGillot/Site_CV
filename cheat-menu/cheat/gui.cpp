...
static bool aimAssistCheckbox = false;
...
{
	// Arrêter les threads avant de détruire ImGui
	isRunning = false;
...
void gui::RenderAimbotTab() noexcept {
	...
	static bool wasAimAssistOn = false;
	static bool aimAssistCheckbox = false;

	if (ImGui::Checkbox("Aim Assist", &aimAssistCheckbox))
	{
		cheat::isAimAssistActive.store(aimAssistCheckbox); // mettre à jour l'état atomique
